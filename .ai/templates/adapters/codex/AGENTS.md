# AI Development Forge — Codex Router

<!-- Generated from .ai/framework and .ai/custom. Do not edit this file directly. -->

## Authority

- The main Codex session is the strong orchestrator. It owns routing, user communication, gates, canonical state changes, and agent coordination.
...
Use native Codex skill invocation: `$forge-skill-name`.
...
Only the orchestrator invokes agents from `.codex/agents/`:
